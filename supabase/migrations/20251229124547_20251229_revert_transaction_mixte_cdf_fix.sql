/*
  # Annulation de la correction du taux de change
  
  ## Description
  Restaure les fonctions create_transaction_mixte_retrait_cdf et 
  create_transaction_mixte_depot_cdf dans leur état d'origine.
  
  ## Modifications
  - Retour à get_active_exchange_rate('USD', 'CDF')
  - Retour à paire_devises = 'USD/CDF'
*/
