/*
  # Correction du Solde Virtuel USD dans les Transactions Mixtes CDF

  ## Description
  Cette migration corrige un bug dans les fonctions de transaction mixte CDF
  où le solde virtuel USD était modifié à tort lors de paiements en USD.

  ## Problème identifié
  Lors d'un retrait de 250,000 CDF payé en 100 USD :
  - Le service virtuel CDF augmentait correctement de 250,000 CDF ✓
  - Le service virtuel USD augmentait incorrectement de 100 USD ✗
  - Le cash USD diminuait correctement de 100 USD ✓

  ## Logique correcte
  Pour un retrait de 250,000 CDF payé en 100 USD :
  - Service virtuel CDF : +250,000 CDF (créance en CDF)
  - Service virtuel USD : INCHANGÉ (pas de créance USD)
  - Cash USD : -100 USD (paiement au client)

  Pour un dépôt de 250,000 CDF reçu en 100 USD :
  - Service virtuel CDF : -250,000 CDF (remboursement de créance)
  - Service virtuel USD : INCHANGÉ (pas de remboursement USD)
...
-- ============================================================================
-- FONCTION 1: RETRAIT CDF PRINCIPAL (CORRECTION)
-- ============================================================================
...
BEGIN
  ...
  -- CORRECTION: Ne toucher QUE au solde virtuel CDF, PAS au solde USD
  UPDATE services
  SET
...
-- ============================================================================
-- FONCTION 2: DÉPÔT CDF PRINCIPAL (CORRECTION)
-- ============================================================================
...
COMMENT ON FUNCTION create_transaction_mixte_retrait_cdf IS 'Retrait CDF mixte - CORRIGÉ: Service virtuel CDF AUGMENTE (créance), Cash DIMINUE, Service virtuel USD INCHANGÉ';
COMMENT ON FUNCTION create_transaction_mixte_depot_cdf IS 'Dépôt CDF mixte - CORRIGÉ: Service virtuel CDF DIMINUE (remboursement), Cash AUGMENTE, Service virtuel USD INCHANGÉ';
