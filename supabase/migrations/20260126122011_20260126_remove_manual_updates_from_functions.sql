/*
  # Suppression des Mises à Jour Manuelles des Soldes

  ## Problème
  Les fonctions de transaction mixte mettent à jour les soldes manuellement,
  puis le trigger update_balances_on_validation les met à jour à nouveau,
  causant une double mise à jour.

  ## Solution
  Supprimer les UPDATE manuels des fonctions et laisser uniquement
  le trigger update_balances_on_validation gérer les soldes.
*/
...
COMMENT ON FUNCTION create_transaction_mixte_retrait_cdf IS 'Retrait CDF mixte - Les soldes sont mis à jour automatiquement par le trigger update_balances_on_validation';
COMMENT ON FUNCTION create_transaction_mixte_depot_cdf IS 'Dépôt CDF mixte - Les soldes sont mis à jour automatiquement par le trigger update_balances_on_validation';
